...
import { Calendar, Users, AlertTriangle, Clock, LogOut, Bell } from "lucide-react";
...
import { useNotificationsSubscription } from "@/hooks/useNotificationsSubscription"; // Add this import
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-primary/10">
              ...
              <div className="relative">
                ...
                <div className="absolute right-0 mt-2 w-80 bg-card border rounded-lg shadow-lg z-20">
                  <div className="p-3 border-b">
                    <p className="font-semibold">New Alerts ({notifications.length})</p>
                  </div>
      ...
      <main className="container mx-auto px-4 py-8">
        {/* ... your existing stats and tabs content ... */}
        
        {/* Update the tabs to include Vacancies for officers too */}
        {isAdminOrSupervisor ? (
          ...
          <Tabs defaultValue="daily" className="space-y-6">
            <TabsList className="grid w-full grid-cols-4"> {/* Changed from 3 to 4 */}
              <TabsTrigger value="daily">Daily Schedule</TabsTrigger>
              <TabsTrigger value="schedule">Weekly Schedule</TabsTrigger>
              <TabsTrigger value="vacancies">Vacancies</TabsTrigger> {/* Added this tab */}
              <TabsTrigger value="requests">Time Off</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="vacancies" className="space-y-6">
              {/* You'll need to create or import a VacancyAlerts component for officers */}
              <VacancyManagement isOfficerView={true} userId={user!.id} />
            </TabsContent>
